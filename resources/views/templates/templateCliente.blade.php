						...
						<ul class="nav navbar-nav">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" >
									Opciones<spam class="caret"> </spam>
								</a>
								<ul class="dropdown-menu">
									<li><a href="reporteDisponibilidad">Consultar disponibilidad</a></li>
									<li><a href="reservacion">Calificar servicios</a></li>
									<li><a href="reservacion">Presupuesto</a></li>							
		...
		<div class="fijo" id="menu">
			...
			<div class="contenedorGeneral">
				<div class="logo-interior3">
					...
					<a href="servicios" style="text-decoration:none"><p class="texto">Servicios</p></a>			
			</div>

			<div class="contenedorGeneral">
				<div class="logo-interior6">
				</div>
					<a href="presupuesto" style="text-decoration:none"><p class="texto">Presupuesto</p></a>			
			</div>			
